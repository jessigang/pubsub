package com.telecom.pubsub.sms.controller;

import io.swagger.v3.oas.annotations.Operation;
import io.swagger.v3.oas.annotations.tags.Tag;
import com.fasterxml.jackson.databind.JsonNode;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.telecom.pubsub.sms.service.NotificationService;
...
@Tag(name = "SMS API", description = "SMS 송부 API")
public class SmsController {
    @Autowired
    private NotificationService notificationService;
    private final ObjectMapper objectMapper = new ObjectMapper();

    @Operation(summary = "SMS 발송 처리", description = "데이터 사용량의 임계치 초과를 SMS로 발송합니다.")
    @PostMapping("/usage")
